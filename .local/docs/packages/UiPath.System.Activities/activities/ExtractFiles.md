...
| `ConflictResolution` | If file already exists | `InArgument` | `FileConflictBehavior` | No | `FileConflictBehavior.Replace` | Behaviour when an extracted file already exists at the destination: `Replace`, `Fail`, or `Rename`. |
